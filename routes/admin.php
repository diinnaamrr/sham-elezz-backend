...
//        });
        ...
        Route::group(['prefix' => 'order', 'as' => 'order.', 'middleware' => ['module:order']], function () {
            ...
            Route::get('all-details/{id}', 'OrderController@all_details')->name('all-details');
             Route::get('count', 'OrderController@getOrderCount')->name('order.count');
        ...
        Route::group(['prefix' => 'business-settings', 'as' => 'business-settings.', 'middleware' => ['module:settings', 'actch']], function () {
            ...
            Route::POST('app-settings', 'BusinessSettingsController@update_app_settings')->name('app-settings');
                      Route::get('app-settings/user', 'BusinessSettingsController@get_user_app_settings')->name('app-settings.user.data');
            Route::get('app-settings/store', 'BusinessSettingsController@get_store_app_settings')->name('app-settings.store.data');
            Route::get('app-settings/deliveryman', 'BusinessSettingsController@get_deliveryman_app_settings')->name('app-settings.deliveryman.data');
            Route::post('app-settings/user', 'BusinessSettingsController@update_user_app_settings')->name('app-settings.user');
            Route::post('app-settings/store', 'BusinessSettingsController@update_store_app_settings')->name('app-settings.store');
            Route::post('app-settings/deliveryman', 'BusinessSettingsController@update_deliveryman_app_settings')->name('app-settings.deliveryman');

...
use App\Http\Controllers\Admin\AdminMenuCategoryControllerv;
use App\Http\Controllers\Admin\AdminMenuItemControllerv;
...
use App\Http\Controllers\Admin\BulkItemController;

Route::delete('admin/item/bulk-delete', [ItemController::class, 'bulkDelete'])->name('admin.item.bulk-delete');

Route::delete('/admin/users/customer/delete/{id}', [CustomerController::class, 'delete'])
    ->name('admin.users.customer.delete');


WebSocketsRouter::webSocket('/delivery-man/live-location', DMLocationSocketHandler::class);

Route::prefix('admin/bulk-items')->name('admin.bulk_items.')->group(function () {
    Route::get('/create', [BulkItemController::class, 'bulkCreate'])->name('create');
    Route::post('/store', [BulkItemController::class, 'bulkStore'])->name('store');
});
...
Route::prefix('admin')->group(function () {
    ...
    Route::get('menu/categories/create', [AdminMenuCategoryControllerv::class, 'create'])->name('admin.menu.categories.create');
    Route::post('menu/categories', [AdminMenuCategoryControllerv::class, 'store'])->name('admin.menu.categories.store');
    Route::get('menu/categories/{id}/edit', [AdminMenuCategoryControllerv::class, 'edit'])->name('admin.menu.categories.edit');
    Route::put('menu/categories/{id}', [AdminMenuCategoryControllerv::class, 'update'])->name('admin.menu.categories.update');
    Route::delete('menu/categories/{id}', [AdminMenuCategoryControllerv::class, 'destroy'])->name('admin.menu.categories.destroy');

    // Menu Items
    Route::get('menu/items', [AdminMenuItemControllerv::class, 'index'] )->name('admin.menu.items.index');
    Route::get('menu/items/create', [AdminMenuItemControllerv::class, 'create'])->name('admin.menu.items.create');
    Route::post('menu/items', [AdminMenuItemControllerv::class, 'store'])->name('admin.menu.items.store');
    Route::get('menu/items/{id}/edit', [AdminMenuItemControllerv::class, 'edit'])->name('admin.menu.items.edit');
    Route::put('menu/items/{id}', [AdminMenuItemControllerv::class, 'update'])->name('admin.menu.items.update');
    Route::delete('menu/items/{id}', [AdminMenuItemControllerv::class, 'destroy'])->name('admin.menu.items.destroy');
});

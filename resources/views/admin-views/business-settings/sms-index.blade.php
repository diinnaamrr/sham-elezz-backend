...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="row g-3">
            ...
            @php($liveValues = is_array($gateway->live_values) ? $gateway->live_values : [])
            @php($gatewayStatus = (int)($liveValues['status'] ?? 0))

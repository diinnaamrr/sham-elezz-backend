                        ...
                        <tr>
                            ...
                            <td>
                                <a class="media align-items-center" href="{{route('admin.item.view',[$item['id']])}}">
                                    ...
                                    data-onerror-image="{{asset('public/assets/admin/img/160x160/img2.jpg')}}" alt="{{ $item->getRawOriginal('name') ?? $item->name }} image">
                                    <div title="{{ $item->getRawOriginal('name') ?? $item['name'] }}" class="media-body">
                                        <h5 class="text-hover-primary mb-0">{{ Str::limit($item->getRawOriginal('name') ?? $item['name'], 20, '...') }}</h5>
                                    </div>
                                </a>
                            </td>
                            ...
                            <td>
                                ...
                                @elseif ($item->is_shared_menu ?? false)
                                {{ translate('messages.all_stores_shared') }}
                                @else

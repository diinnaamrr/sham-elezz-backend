                            ...
                            <div class="row g-2 align-items-end">
                                ...
                                <div class="col-sm-6 col-lg-3 d-none" id="shared_menu_stock_wrapper">
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="number" name="shared_menu_default_stock" id="shared_menu_default_stock" class="form-control" min="0" value="0" placeholder="0">
...
@push('script_2')
    ...
    <div class="col-xl-4 col-lg-6">
        ...
        function toggleSharedMenuUi() {
            var isShared = $('#is_shared_menu').is(':checked');
            if (isShared) {
                $('#shared_menu_stock_wrapper').removeClass('d-none');
                $('#store_id_wrapper').addClass('d-none');
                $('#store_id').removeAttr('required').val(null).trigger('change');
        ...
        $('#item_form').on('submit', function(e) {
            ...
            $.ajax({
                ...
                error: function(xhr) {
                    var msg = "{{ translate('messages.failed_to_add_product') }}";
                    if (xhr.responseJSON && xhr.responseJSON.errors) {
                        ...
                        toastr.error(msg || xhr.statusText || 'Error', {
                            CloseButton: true,
                            ProgressBar: true
                        });
                    }
        ...
        $('#reset_btn').click(function() {
            $('#is_shared_menu').prop('checked', false);
            $('#shared_menu_default_stock').val(0);
            if (typeof toggleSharedMenuUi === 'function') toggleSharedMenuUi();

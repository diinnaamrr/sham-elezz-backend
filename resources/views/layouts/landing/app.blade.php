        ...
        <div class="navbar-bottom">
            <div class="container">
                <div class="navbar-bottom-wrapper">
                    ...
                    src="{{asset('public/assets/landing/img/shamelezz.png')}}"
            ...
            <div class="container">
                <div class="newsletter-wrapper">
                    <div class="newsletter-content position-relative">
                        <h3 class="title">{{ translate('messages.Sign Up to Our restaurant') }}</h3>
                        <div class="text">
                            {{ translate('messages.Be the first to know about what is new in our kitchen') }}
                        </div>
                        <form method="post" action="{{route('newsletter.subscribe')}}">
                            @csrf
                            <div class="input--grp">
                                <input type="email" name="email" required class="form-control" placeholder="{{ translate('messages.Enter your email address') }}">
                                    ...
                                    <svg width="46" height="46" viewBox="0 0 46 46" fill="none"
                                        ...
                                        <defs>
                                            <linearGradient id="paint0_linear_28_1864" x1="-2.04694e-07" y1="23.4694"
                                                ...
                                                <stop stop-color="#800519" />
                                                <stop offset="1" stop-color="#800519" />
                                            </linearGradient>
                                        </defs>
                                    </svg>
                                </button>
                ...
                <div class="footer-wrapper ps-xl-5">
                    <div class="footer-widget">
                        <div class="footer-logo">
                            <a class="logo">
                                <img  class="onerror-image"  data-onerror-image="{{ asset('public/assets/landing/img/shamelezz.png') }}" src="{{\App\CentralLogics\Helpers::get_full_url('business', $logo?->value?? '', $logo?->storage[0]?->value ?? 'public','favicon')}}" alt="image">
                            </a>
                        </div>
                        <div class="txt">
                            {{ translate('messages.sham_el_ezz') }}
                        </div>

...
class BusinessSettingObserver
{
    ...
    {
        // Explicitly forget critical keys first to ensure they are cleared even if DB query fails
        ...
        try {
            ...
            // Table might not exist or other DB issue, ignore as we've already cleared critical keys
        }
    }
}

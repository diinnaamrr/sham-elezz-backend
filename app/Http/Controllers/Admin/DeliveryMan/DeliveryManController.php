...
class DeliveryManController extends BaseController
{
    ...
    public function updateStatisticsVisibility(Request $request): RedirectResponse
    {
        $this->deliveryManRepo->update(id: $request['id'], data: ['show_statistics_in_app' => $request['status']]);
        Toastr::success('Driver app statistics visibility updated');
        return back();
    }

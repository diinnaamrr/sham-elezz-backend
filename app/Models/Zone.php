...
class Zone extends Model
{
    ...
    {
        return $this->belongsToMany(Module::class)->withPivot(['per_km_shipping_charge','minimum_shipping_charge','maximum_shipping_charge','maximum_cod_order_amount',
            'base_distance_km',
            'base_fee',
            'extra_price_per_km',])->using('App\Models\ModuleZone');
    }
